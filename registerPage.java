	...
	public registerPage() {
		...
		btnRegister.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				/*PasswordValidator validator = PasswordValidator.buildValidator(true, true, true, 6, 14);
				*/
				/* @SuppressWarnings("static-access"); */
				/* assert (validator.validatePassword("password1")) : "FORMAT password  add Speciam Caps and length b/w 6 and 14";
				 */
